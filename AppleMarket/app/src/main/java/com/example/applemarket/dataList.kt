...
val dataList = mutableListOf(
    PostingData(
        1, R.drawable.sample1, "산진 한달된 선풍기 팝니다",
        "이사가서 필요가 없어졌어요 급하게 내놓습니다",
        "대현동", 1000, "서울 서대문구 창천동", 13, 25
    ),
    PostingData(
        2, R.drawable.sample2, "김치냉장고",
        "이사로인해 내놔요",
    ...
    PostingData(
        6, R.drawable.sample6, "프라다 복조리백 (제목 말줄임표 적용된 모습이 안보이길래 제목을 마구마구 늘리도록 하겠습니다~~~~~~~~~~~~~~)",
        "까임 오염없고 상태 깨끗합니다\n정품여부모름",
    ...
    PostingData(
        ...
        "울산 동해바다뷰 60평 복층 펜트하우스 1일 숙박권\n" +
                ...
                "4. 예약방법: 예약금 50,000원 하시면 저희는 명함을 드리며 입실 오전 잔금 입금하시면 저희는 동.호수를 알려드리며 " +
                "고객님은 예약자분 신분증 앞면 주민번호 뒷자리 가리시거나 지우시고 문자로 보내주시면 저희는 카드키를 우편함에 놓아 둡니다.\n" +
